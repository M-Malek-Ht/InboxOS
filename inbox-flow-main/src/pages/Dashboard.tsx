      ...
      <div className="p-6 space-y-6 max-w-7xl mx-auto">
        ...
        >
          {isLoading ? (
            ...
            <>
              <motion.div variants={fadeUp}><StatCard icon={Mail} label="Unread Emails" value={stats.unreadCount} href="/inbox" /></motion.div>
              <motion.div variants={fadeUp}><StatCard icon={AlertCircle} label="Needs Reply" value={stats.needsReplyCount} href="/inbox" color="amber" /></motion.div>
              <motion.div variants={fadeUp}><StatCard icon={CheckSquare} label="Open Tasks" value={stats.openTasks} href="/workflows" /></motion.div>
              <motion.div variants={fadeUp}><StatCard icon={Calendar} label="Upcoming Events" value={stats.upcomingEvents} href="/calendar" color="blue" /></motion.div>
            </>
          )}
        </motion.div>
        ...
        <Card className="hover:border-muted-foreground/30 transition-colors cursor-pointer">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <Icon className={`h-5 w-5 ${color === 'amber' ? 'text-priority-med' : color === 'blue' ? 'text-primary' : 'text-muted-foreground'}`} />
            </div>
            <motion.div
